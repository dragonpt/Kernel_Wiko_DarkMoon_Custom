...
#CM 
#Wiko DarkMoon, Add this to fix the MT6582/92 MTK PATHs
export MTK_ROOT_CUSTOM=./mediatek/custom/ MTK_PATH_SOURCE=./mediatek/kernel/ MTK_PATH_PLATFORM=./mediatek/platform/mt6582/kernel/ ARCH_MTK_PLATFORM=mt6582 
...
cp kernelFile ../build_result/kernel/zImage

echo "####       Copying all kernel modules to /build_result/modules/                  ####"
